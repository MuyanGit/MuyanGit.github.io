...
var SimpleCore = {
  ...
  changeReadModel: function () {
    ...
    if (SimpleCore.getLocalData('read-mode') == 'night') {
      ...
      $('.cover-img').css({
        'background': "url('https://cdn.jsdelivr.net/gh/MuyanGit/ImageHosting/images/cover2.jpg')",
        'background-image': 'https://cdn.jsdelivr.net/gh/MuyanGit/ImageHosting/images/cover2.jpg',
      ...
      $('.cover-img').css({
        'background': "url('https://cdn.jsdelivr.net/gh/MuyanGit/ImageHosting/images/cover1.jpg')",
        'background-image': 'https://cdn.jsdelivr.net/gh/MuyanGit/ImageHosting/images/cover1.jpg',
        'background-size': 'cover',
        'background-position': 'center',
        'background-repeat': 'no-repeat'
      })
