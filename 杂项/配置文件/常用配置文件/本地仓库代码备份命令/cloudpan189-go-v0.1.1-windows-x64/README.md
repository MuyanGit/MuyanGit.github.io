...
# 切换 根目录
cloudpan189-go cd /
cloudpan189-go cd /同步盘/配置文件/搜狗快捷键/
...
cloudpan189-go backup C:\Users\HI\AppData\LocalLow\SogouPY.users\00000002\Phrases.ini /同步盘/配置文件/搜狗快捷键/
cloudpan189-go backup C:\Users\HI\AppData\LocalLow\SogouPY\Phrases.ini /同步盘/配置文件/搜狗快捷键/Phrases/
```
